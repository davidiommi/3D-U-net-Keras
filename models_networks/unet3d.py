...
from keras.layers import Conv3D, MaxPooling3D, UpSampling3D, Activation, BatchNormalization, PReLU, Deconvolution3D, SpatialDropout3D, Conv3DTranspose
...
if __name__ == '__main__':
    ...
    generator = unet_model_3d(input_shape=(1,128,128,128,1))
    generator.summary()
